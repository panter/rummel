...
const documents = {
    ...
    "\n  fragment SearchRequestImages on SearchRequest {\n    id\n    assets {\n      id\n      tags\n      asset {\n        id\n        url\n        originalFilename\n        mimeType\n        updatedAt\n      }\n    }\n  }\n": types.SearchRequestImagesFragmentDoc,
    "\n  query searchRequestImages($where: EntityIdInput!) {\n    searchRequest(where: $where) {\n      id\n      buildingComponentName\n      project {\n        id\n        name\n        shortName\n      }\n      ...SearchRequestImages\n    }\n  }\n": types.SearchRequestImagesDocument,
